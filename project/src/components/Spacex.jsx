...
import pac from './spacex.module.css';
const Spacex = () => {
  return (
    <div id={pac.back}>
     <section id={pac.space}>
        <article>
            {/* <div className={pac.class1}><svg version="1.1" x="0px" y="0px" viewBox="0 0 400 50">
        ...
        <g class="letter_swoosh">
          <path class="fill-white" d="M399,0.7c-80,4.6-117,38.8-125.3,46.9l-1.7,1.6h14.8C326.8,9.1,384.3,2,399,0.7L399,0.7z"></path>
            ...
            <div className={pac.class2}><ul>
            <li><a href="">FALCON 9</a></li>
            <li><a href="">FALCON HEAVY</a></li>
            <li><a href="">DREGON</a></li>
            <li><a href="">STARSIP</a></li>
            <li><a href="">HUMAN SPACEFLIGHT</a></li>
            <li><a href="">RIDESHARE</a></li>
            <li><a href="">STARSHIELD</a></li>
            <li><a href="">STARLINK</a></li></ul>
            </div>
            <div className={pac.class3}>
                <ul><li><a href="">SHOP</a></li>
            <li><i class="fa-solid fa-bars"></i></li></ul>
            </div>
        </article>
     </section>
    </div>
